    ...
    public partial class Init : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                table: "Devices",
                columns: new[] { "Id", "AvailableQuantity", "Deposit", "Description", "ImageUrl", "Name", "PricePerDay" },
                values: new object[,]
                {
                    { 1, 10, 200m, "Urządzenie do elektrostymulacji mięśni.", null, "Elektrostymulator COMPEX", 25m },
                    { 2, 3, 300m, "ALternatywa dla kul", null, "iWalk", 35m },
                    { 3, 2, 400m, "Kompresja pneumatyczna do regeneracji.", null, "Reboots", 45m },
                    { 4, 10, 500m, "Kregulowane składane ergonomiczne amortyzujące wstrząsy kule.", null, "Kule Ergobaum ", 20m },
                    { 5, 15, 50m, "Połączenie chłodzenia i aktywnego ucisku.", null, "Cold recovery", 10m }
                });
